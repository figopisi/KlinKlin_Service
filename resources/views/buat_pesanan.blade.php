                ...
                <ol class="steps-list">
                    ...
                    <li>
                        ...
                        <div class="copy-container">
                            ...
                            <textarea class="copy-box" readonly onclick="this.select()">Nama lengkap:
Nomor telepon yang aktif:
Alamat customer:
Alamat laundry: (Jika tidak ada alamat spesifik, kami yang akan menentukan laundry)
Jasa pilah: Iya/Tidak
Metode bayar: cash di tempat/transfer</textarea>
